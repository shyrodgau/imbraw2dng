...
#version = "V3.5.7_dev"; // actually const
...
#texts = { // actually const
	...
	onimback: {
		...
		errconnect: {
			...
			ja: '\x1b[31mエラー\x1b[0m $$0 でImB に接続しています! ImB WiFi ですか?'
		},
		nomatch: {
		...
		strangenamex: {
			...
			ja: '\x1b[31m警告:\x1b[0m 無効なファイル名: $$0'
		},
		invaltime: {
		...
		invaltimex: {
			...
			ja: '\x1b[31mERROR:\x1b[0m 無効なタイムスタンプ: $$0'
		},
	},
	process: {
		singlestep: {
		...
		erraccessx: {
			...
			ja: '\x1b[31mエラー\x1b[0m アクセス中に発生しました $$0. 申し訳ございません!'
		},
		notraw: {
		...
		errorreadingfilex: {
			...
			ja: '\x1b[31mエラー\x1b[0m ファイル $$0 の読み取り中に発生しました。 申し訳ございません!'
		},
		unknownsize: {
		...
		unknownsizex: {
			...
			ja: '[$$0] \x1b[31m申し訳ありませんが、ファイルサイズ $$1 は既知の形式と一致しません。開発者にお問い合わせください。\x1b[0m'
		},
		processing: {
		...
		errsave: {
			...
			ja: '\x1b[31mエラー!\x1b[0m ファイル $$0 に書き込めませんでした'
		},
		droppedn: {
	...
	node: {
		...
		help: {
			...
			ja: [
				'\x1b[1mimbraw2dng へようこそ\x1b[0m $$0 !', 'Usage: node $$0 \x1b[1m[\x1b[0m-l lang\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-f\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-d dir\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-nc \x1b[1m|\x1b[0m -co\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-R\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-J\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-O\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m-n yyyy_mm_dd-hh_mm_ss\x1b[1m]\x1b[0m \x1b[1m[\x1b[0m \x1b[1m[\x1b[0m--\x1b[1m]\x1b[0m \x1b[1m<\x1b[0mfiles-or-dirs\x1b[1m>*\x1b[0m \x1b[1m]\x1b[0m',
				'オプション:',
				' \x1b[1m-h\x1b[0m - このヘルプを表示する',
				' \x1b[1m-nc\x1b[0m - 色付きのテキストを使用しない',
				' \x1b[1m-co\x1b[0m - 色付きのテキストを強制',
				' \x1b[1m-l XX\x1b[0m - ここで、XX は有効な言語コードです (現在: DE、EN、FR、JA)',
				...
				' \x1b[1m-n yyyy_mmdd_hhmmss\x1b[0m (または任意の長さのプレフィックス) - ImB からこのタイムスタンプより新しいもののみを選択する',
				' -----',
				' \x1b[1m--\x1b[0m - 残りのパラメータをローカル ファイルまたはディレクトリとして扱う',
		...
		unkopt: {
			...
			ja: '\x1b[31m最後のパラメータの値が欠落しています。\x1b[0m'
		},
		missingval: {
		...
		fnwarn: {
			...
			ja: '\x1b[31m警告:\x1b[0m $$0 lタイムスタンプのようですが、 \x1b[1m-n\x1b[0m または \x1b[1m--\x1b[0m 手前にあるのを忘れましたか?'
		},
		renamed: {
			en: '(renamed)',
			de: '(umbenannt)',
