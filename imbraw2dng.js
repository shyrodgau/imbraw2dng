...
class ImBCBase {
/* Indentation out */
static version = "V3.7.9_63c5e09"; // actually const
...
static getwb(view, typidx) {
	...
	g = (g/2);
	if ((r <= b) && (r <= g)) {
		return [ 10, 10, Math.floor(90000*g/r), 90000, Math.floor(90000*b/r), 90000 ]
	}
	else if ((b <= r) && (b <= g)) {
		return [ Math.floor(90000*r/b), 90000, Math.floor(90000*g/b), 90000, 10, 10 ]
	}
	else {
		return [ Math.floor(90000*r/g), 90000, 10, 10, Math.floor(90000*b/g), 90000 ]
	}
}
